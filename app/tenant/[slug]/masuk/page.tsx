...
import { LoginForm } from "@/app/(auth)/masuk/login-form";
    ...
    <main className="min-h-dvh bg-muted px-4 py-10">
      <div className="mx-auto max-w-md rounded-3xl border border-border bg-card p-6 sm:p-8">
        <Link href="/" className="font-display text-2xl font-extrabold">
          <span className="text-tenant">Ayo</span>Pilih
        </Link>
        <div className="mt-8">
          <h1 className="font-display text-3xl font-bold">Masuk panitia</h1>
          <p className="mt-3 text-muted-foreground">Masuk dari subdomain tenant agar sesi admin tersimpan di ruang yang benar.</p>
        </div>
        <div className="mt-8">
